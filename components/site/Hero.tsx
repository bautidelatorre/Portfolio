...
export function Hero() {
  return (
    <section className="dot-grid relative flex min-h-[85vh] flex-col justify-center overflow-hidden px-6 sm:px-10 lg:px-16 2xl:px-24">
      <div
        aria-hidden="true"
        className="pointer-events-none absolute top-1/2 right-[2%] h-[560px] w-[560px] -translate-y-1/2 rounded-full bg-[radial-gradient(circle,rgba(255,106,0,0.75)_0%,rgba(255,106,0,0.35)_45%,rgba(255,106,0,0)_72%)] blur-[70px]"
      />
      <div
        aria-hidden="true"
        className="pointer-events-none absolute top-[42%] right-[11%] h-[220px] w-[220px] -translate-y-1/2 rounded-full bg-[#ff7a1a] opacity-70 blur-[60px]"
      />
      <div
        aria-hidden="true"
      ...
      <FloatingRender
        ...
        duration={11}
        opacity={0.95}
        className="right-0 bottom-0 hidden w-[660px] xl:block 2xl:w-[880px]"
      />
